...
<div class="main-content">
  ...
  <div class="schedule-section">
    <div class="schedule-header">
      ...
      <a href="admin-schedule.html" class="view-schedule-btn">View Appointments</a>
    </div>
  ...
  <div class="status-cards">
    <div class="status-card">
      ...
      <a href="admin-appointment.html" class="action-btn">Review Bookings</a>
    </div>
    <div class="status-card">
      <div class="status-info">
      ...
      <a href="admin-customerdetails.html" class="action-btn">Contact</a>
    </div>
  </div>
</div>
